...
const animate = (() => {
  ...
  ["el", "delay", "begin", "complete", "each", "loop", "direction"].forEach(key => defaults.set(key, null));
  ...
  const each = (progress, params) => {
    if (params.get("each")) params.get("each")(progress);
  };
